...
export function Form(props: JSX.HTMLAttributes<HTMLFormElement>) {
  return (
    <>
      <form class="">
        <div class="relative flex p-4 space-x-2" data-te-input-wrapper-init>
          <input
            type="text"
            class="peer block border border-blue-300 min-h-[auto] w-full rounded bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-0  "
            id="prompt"
